...
@fig-4 shows the trend of support rate changes for each candidate before the upcoming election, as well as the model's predicted values for the next 20 days.We predicts that Donald Trump may win based on our model.
```{r}
#| label: fig-4
...
>>>>>>> cadfff05ead6aebff23ab03f96847c7f519121a6
